...
* Erstellen Sie im Ordner `2025` unter `wanderungen` einen neuen Ordner und benennen Sie ihn z. B. `stanserhorn`. Siehe: +
    image:organisation.png[width=600,height=300],
